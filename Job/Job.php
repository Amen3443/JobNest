...
include "Jobfilters.php";
include "Companyfilter.php";
?>
            ...
            <div class="jobvaccancy">
                ...
                <div class="joblists">
                        <div class="jobdashboard">    
                                    <?php 
                                    if ((isset($_POST['filter']) && $_POST['filter'] !='') ||(isset($_POST['option']) && $_POST['option'] !='') || (isset($_POST['type']) && $_POST['type'] !='') ||(isset($_POST['box'] )&& $_POST['box']!='')|| (isset($_POST['company']) && $_POST['count']!=0) ) {
                        ...
                        if (isset($_POST['company']) ) {
                            if ( $_POST['count']==0) {
                                echo "<div class='jobdetails'>
                                <h3 >No JOBS Available for These Company</h3>
                                </div>";
                               }
                        }
                      if (!isset($_POST['company']) ) {
